...
export default function CasinoSections() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0b1530] to-[#050b1e] text-white font-sans">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          {[{
            ...
            >
              ...
              <div className="p-6">
                <span className="inline-block mb-3 text-xs bg-yellow-400 text-black px-3 py-1 rounded-full">
                  24 Aug, 2022
                </span>

export default function LatestTransactions() {
  ...
  const transactions = [
    ...
    { id: "#RWVKD6UXAT5", user: "shangil007", date: "2025-08-16 07:43 PM", amount: "$10.00" },
    { id: "#F9HH587XAF8", user: "shangil007", date: "2025-08-16 07:43 PM", amount: "$5.00" },
  ];

  return (
    <section className="bg-[#040b1f] text-white py-20">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          {/* Winners */}
          <div className="bg-[#07183a] rounded-xl p-6">
          ...
          {/* Transactions */}
          <div className="md:col-span-2 bg-[#07183a] rounded-xl overflow-hidden">
